          ...
          parts: [
            {
              ...
              text: `วิเคราะห์รูปภาพนี้อย่างแม่นยำ และตอบกลับเป็น JSON เท่านั้น (ห้ามมีคำพูดอธิบายอื่นปนมาเด็ดขาด):\n{\n  "type": "เลือก 1 ข้อความจากลิสต์นี้เท่านั้น ห้ามพิมพ์ผิดแม้แต่ตัวอักษรเดียว: 'ไฟป่า / หมอกควัน', 'ดินโคลนถล่ม / ดินสไลด์', 'น้ำป่าไหลหลาก / น้ำท่วม', 'ต้นไม้ล้มขวางทาง', 'แผ่นดินไหว', 'อื่นๆ'",\n  "severity": <ตัวเลขความรุนแรง 1 ถึง 5>,\n  "description": "อธิบายสิ่งที่เห็นสั้นๆ"\n}`
            },
            {
