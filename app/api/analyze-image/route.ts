...
export async function POST(req: NextRequest) {
  try {
    ...
    const prompt = `
      คุณคือผู้เชี่ยวชาญด้านภัยพิบัติของเทศบาลตำบลบ่อหลวง จงวิเคราะห์รูปภาพนี้แล้วตอบกลับมาเป็น JSON เท่านั้น
      ห้ามตอบเป็นข้อความอื่นเด็ดขาด รูปแบบ JSON ที่ต้องการคือ:
      {
